// ─── ACORD Dataset Page ───────────────────────────────────────────────────────
// Atticus Clause Retrieval Dataset — 126,000+ query-clause pairs, ACL 2025.
//
// QUICK EDITS:
//   - Stat pills: edit the `stats` array
//   - Description paragraphs: edit the body <p> blocks
//   - arXiv / GitHub links: search "arxiv.org/abs/2501.06582" or "TheAtticusProject/acord"
//   - Contributors: edit the `contributors` array
// ──────────────────────────────────────────────────────────────────────────────
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "ACORD Dataset | The Atticus Project",
};

import Link from "next/link";

export default function ACORDPage() {
  const stats = ["126,000+ query-clause pairs", "114 queries", "Fully expert-annotated", "CC BY 4.0"];

  const contributors = [
    {
      title: "Attorney Annotators",
      names: ["Wei Chen", "Yuji Sun", "Tao Zhang", "Benjamin Hendrick", "Stacey Phillip", "Alexander Kwonji Rosenberg", "Michelle Sonu", "Chris Herbst", "Hannah Kang", "Andy Song", "Tim Evans", "Ji-Hyun Park"],
    },
    {
      title: "Dataset Leads & Students",
      names: ["Yuyang Sun", "Sarah Harrell", "Adam Shankman", "Lyla Sax", "Jerry Jiang", "Tarunya Dharmarajan", "Liam Percer", "Penelope Chung", "Kevin Chen"],
    },
    {
      title: "AI Researchers & Technical",
      names: ["Steven Wang", "Andreas Plesner", "Maksim Zubkov", "Kexin Fan", "Max Emanuel", "Evan Wang", "Anya Chen"],
    },
  ];
      ...
      <section style={{ background: "linear-gradient(135deg, var(--ink) 0%, #162038 55%, #1a2a4a 100%)", padding: "4rem 0" }}>
        <div className="container">
          ...
          <h1 style={{ color: "white", marginBottom: "1rem", fontSize: "2.75rem", fontWeight: "800", lineHeight: "1.2" }}>
            Atticus Clause Retrieval<br />Dataset{" "}
            <span style={{ color: "var(--slate)" }}>(ACORD)</span>
          </h1>
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            {[
              ...
              { href: "https://github.com/TheAtticusProject/acord", label: "Code ↗" },
            ...
            <div id="dataset">
              ...
              <div style={{
                ...
                <div style={{ borderBottom: "1px solid var(--border)", paddingBottom: "1.25rem", marginBottom: "1.25rem" }}>
                  <p style={{ fontWeight: "700", marginBottom: "0.5rem", fontSize: "0.95rem", color: "var(--ink)" }}>ACORD v1</p>
                  <a href="https://github.com/TheAtticusProject/acord" target="_blank" rel="noopener noreferrer"
                    style={{ fontSize: "0.85rem", color: "var(--purple)", textDecoration: "none", display: "block", marginBottom: "0.3rem" }}>
                    README / Datasheet →
                  </a>
                  <a href="https://github.com/TheAtticusProject/acord/releases" target="_blank" rel="noopener noreferrer"
              ...
              <div id="publication" style={{
                ...
                <p style={{ fontSize: "0.9rem", color: "var(--text-body)", lineHeight: "1.8", marginBottom: "1rem" }}>
                  Accepted at <strong>ACL 2025</strong> — the 63rd Annual Meeting of the Association for Computational Linguistics.
                </p>
                <p style={{ fontSize: "0.85rem", fontStyle: "italic", color: "var(--text-muted)", marginBottom: "1rem" }}>
                  "ACORD: An Expert-Annotated Retrieval Dataset for Legal Contract Drafting"
                </p>
                <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                  <a href="https://arxiv.org/abs/2501.06582" target="_blank" rel="noopener noreferrer"
      ...
      <section id="contributors" className="section" style={{ background: "var(--off-white)" }}>
        <div className="container">
          ...
          <p style={{ fontSize: "0.8rem", color: "var(--text-muted)" }}>
            Subject to our{" "}
            <Link href="/privacy-policy" style={{ color: "var(--purple)", textDecoration: "none" }}>privacy policy</Link>{" "}
            and{" "}
